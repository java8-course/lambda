...
public class Lambdas03Exercise {
    ...
    public void strSum() {
        ...
        final GenericProduct<String> prod1 = (a, i) -> stringProd(a, i);
        final GenericProduct<String> prod2 = (a, i) -> {return stringProd(a, i);};

        assertEquals(prod.prod("a", 2), "aa");
        assertEquals(prod1.prod("a", 2), "aa");
        assertEquals(prod2.prod("a", 2), "aa");
    }
