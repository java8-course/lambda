...
public class Mapping {
    ...
    public void mapping() {
        ...
        final List<Employee> mappedEmployees =
                new MapHelper<>(employees)
                        ...
                        .map(employee -> employee.withJobHistory(changePositionName(employee.getJobHistory())))
                        .getList();
    ...
    private List<JobHistoryEntry> changePositionName(List<JobHistoryEntry> jobHistory) {
