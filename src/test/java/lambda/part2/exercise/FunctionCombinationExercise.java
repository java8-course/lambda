...
public class FunctionCombinationExercise {
    ...
    public void personHasNotEmptyLastNameAndFirstName2() {
        ...
        final Predicate<Person> validateFirstName = negate(p -> p.getFirstName().isEmpty()); // TODO use negate
        final Predicate<Person> validateLastName = negate(p -> p.getLastName().isEmpty()); // TODO use negate
