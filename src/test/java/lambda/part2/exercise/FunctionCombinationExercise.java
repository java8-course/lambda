...
public class FunctionCombinationExercise {
    ...
    public void personHasNotEmptyLastNameAndFirstName2() {
        ...
        final Predicate<Person> validateFirstName = this.negate(hasEmptyFirstName); // TODO use negate
        final Predicate<Person> validateLastName = this.negate(hasEmptyLastName); // TODO use negate

        final Predicate<Person> validate = this.and(validateFirstName, validateLastName); // TODO use and
